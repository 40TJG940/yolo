					...
					array(
						...
						'fields' => array(
							...
							array(
								...
								'title_info' => __( '<div class="lw-info-label">Date Format</div><div class="lw-short-content">Choose the most common date format for your visitors.</div><a class="lw-open-docs" href="https://locationweather.io/docs/how-to-set-the-date-format/" target="_blank">Open Docs</a>', 'location-weather' ),
								'options'    => array(
							...
							array(
								...
								'title'   => 'Timezone',
								'options' => array(
									''          => __( 'Select an Timezone', 'location-weather' ),
							...
							array(
								...
								'title_info' => __( '<div class="lw-info-label">OpenWeatherMap Language</div> <div class="lw-short-content">Set the Language for the weather view data. English is set as default language.</div>', 'location-weather' ),
								'options'    => array(
					...
					array(
						...
						'fields' => array(
							...
							array(
								...
								'title_info'       => __(
									'<div class="lw-info-label">Icon Type</div><div class="lw-short-content">Choose a icon type to visually represent various weather conditions in current weather. These icon sets offer a variety of design options for displaying current weather information.</div><div class="info-button"><a class="lw-open-docs" href="https://locationweather.io/docs/how-to-configure-current-weather-icon-type/" target="_blank">Open Docs</a></div>',
									'location-weather'
								),
							...
							array(
								'type'    => 'notice',
								'style'   => 'normal',
								'content' => 'To show more weather details & stylish icons, <a class="lw-open-live-demo" href="https://locationweather.io/pricing/?ref=1" target="_blank"><strong>Upgrade to Pro!</strong></a>',
							),
						),
					),
					array(
						...
						'fields' => array(
							array(
								...
								'title_info' => __( '<div class="lw-info-label">Atmospheric or Air Pressure</div> It indicates atmospheric or air pressure on the sea level.', 'location-weather' ),
								'default'    => true,
								'text_on'    => __( 'Show', 'location-weather' ),
								'text_off'   => __( 'Hide', 'location-weather' ),
								'text_width' => 75,
							...
							array(
								...
								'title_info' => __( '<div class="lw-info-label">Air Quality</div> <div class="lw-short-content">Set weather for specific locations with coordinates to display the Air Quality. </div>', 'location-weather' ),
								'default'    => false,
								'text_on'    => __( 'Show', 'location-weather' ),
								'text_off'   => __( 'Hide', 'location-weather' ),
								'text_width' => 75,
							...
							array(
								...
								'title_info' => __( '<div class="lw-info-label">Moonrise & Moonset Time</div> <div class="lw-short-content">Set weather for specific locations with coordinates to display the Moonrise & Moonset Time. </div>', 'location-weather' ),
								'default'    => false,
								'text_on'    => __( 'Show', 'location-weather' ),
								'text_off'   => __( 'Hide', 'location-weather' ),
								'text_width' => 75,
							...
							array(
								...
								'title_info' => __( '<div class="lw-info-label">Moon Phase</div> <div class="lw-short-content">Set weather for specific locations with coordinates to display the Moon Phase. </div>', 'location-weather' ),
								'default'    => false,
								'text_on'    => __( 'Show', 'location-weather' ),
								'text_off'   => __( 'Hide', 'location-weather' ),
								'text_width' => 75,
							...
							array(
								...
								'title_info' => __( '<div class="lw-info-label">Display National Weather Alerts</div> <div class="lw-short-content">Set weather for specific locations with coordinates to display the National Weather Alerts.</div>', 'location-weather' ),
								'default'    => false,
								'text_on'    => __( 'Show', 'location-weather' ),
								'text_off'   => __( 'Hide', 'location-weather' ),
								'text_width' => 75,
							...
							array(
								'type'    => 'notice',
								'style'   => 'normal',
								'content' => 'To gain access to additional weather data, <a class="lw-open-live-demo" href="https://locationweather.io/pricing/?ref=1" target="_blank"><strong>Upgrade to Pro!</strong></a>',
							),
						),
					),
					array(
						...
						'fields' => array(
							array(
								...
								'title_info' => __(
									'<div class="lw-info-label">Additional Data Layout</div><div class="lw-short-content">These styles allow you to choose the presentation that best suits your design and provides additional customization options for displaying weather data. See how it works.</div><div class="info-button"><a class="lw-open-docs" href="https://locationweather.io/docs/how-to-set-weather-additional-data-layout/" target="_blank">Open Docs</a><a class="lw-open-live-demo" href="https://locationweather.io/demos/additional-data-layouts/" target="_blank">Live Demo</a></div>',
									'location-weather'
								),
								'default'    => 'center',
							...
							array(
								...
								'default'    => 'clean',
								'title_info' => __(
									'<div class="lw-info-label">Layout Style</div><div class="lw-short-content">Layout Styles provide different visual presentations for your weather data, allowing you to choose the one that best fits your design preferences.</div><div class="info-button"><a class="lw-open-docs" href="https://locationweather.io/docs/how-to-configure-weather-additional-data-layout-style/" target="_blank">Open Docs</a></div>',
									'location-weather'
								),
							...
							array(
								...
								'title_info' => __(
									'<div class="lw-info-label">Icon Type</div><div class="lw-short-content">Choose an icon set of three distinct sets of icons for displaying additional weather data. These icon sets enhance the visual presentation of additional weather data nicely.</div><div class="info-button"><a class="lw-open-docs" href="https://locationweather.io/docs/how-to-choose-weather-additional-data-icon/" target="_blank">Open Docs</a></div>',
									'location-weather'
								),
							...
							array(
								...
								'title_info'      => __( '<div class="lw-img-tag"><img src="' . SPLW::include_plugin_url( 'assets/images/space.webp' ) . '" alt=""></div><div class="lw-info-label img">Space</div>', 'location-weather' ),
								'dependency'      => array( 'weather-view|weather-additional-data-layout', '==|any', 'vertical|column-two-justified,column-two,justified,left,center', true ),
							),
							array(
							...
							array(
								...
								'content' => 'To display weather data in <a class="lw-open-live-demo" href="https://locationweather.io/demos/additional-data-layouts/" target="_blank">Additional Styles</strong></a> with advanced customizations, <a class="lw-open-live-demo" href="https://locationweather.io/pricing/?ref=1" target="_blank"><strong>Upgrade to Pro!</strong></a>',
							),
							array(
							...
							array(
								...
								'title_info' => __( '<div class="lw-info-label">AutoPlay Delay Time</div>Set autoplay delay or interval time. The amount of time to delay between automatically cycling a weather item. e.g. 1000 milliseconds(ms) = 1 second. ', 'location-weather' ),
							...
							array(
								...
								'type'       => 'spinner',
								'class'      => 'lw-forecast-data-pro',
								'title_info' => __( '<div class="lw-info-label">Carousel Speed</div>Set carousel scrolling speed. e.g. 1000 milliseconds(ms) = 1 second.', 'location-weather' ),
							...
							array(
								...
								'style'   => 'normal',
								'class'   => 'notice-padding',
								'content' => 'To unlock the <a class="lw-open-live-demo" href="https://locationweather.io/demos/weather-carousel/" target="_blank">Weather Data Carousel</a> with flexible options, <a class="lw-open-live-demo" href="https://locationweather.io/pricing/?ref=1" target="_blank"><strong>Upgrade to Pro!</strong></a>',
							),
						),
					),
					array(
						...
						'fields' => array(
							...
							array(
								...
								'text_width' => 94,
								'title_info' => __(
									'<div class="lw-info-label">Enable Weather Forecast</div><div class="lw-short-content">This option allows you to enable or activate weather forecasts, providing users with future weather predictions and enhancing the utility of your weather feature.</div>',
									'location-weather'
								),
							),
							array(
							...
							array(
								...
								'title_info' => __(
									'<div class="lw-info-label">Weather Forecast Type</div><div class="lw-short-content">The Weather Forecast Type option offers flexibility by allowing you to choose between daily, hourly, or a combination of both formats for displaying weather forecasts.</div><div class="info-button"><a class="lw-open-docs" href="https://locationweather.io/docs/how-to-configure-weather-forecast-type/" target="_blank">Open Docs</a><a class="lw-open-live-demo" href="https://locationweather.io/demos/daily-hourly-weather-forecast/" target="_blank">Live Demo</a></div>',
									'location-weather'
								),
								'default'    => 'both',
								'dependency' => array( 'lw-enable-forecast', '==', 'true' ),
							...
							array(
								...
								'title_info' => __( '<div class="lw-info-label">Forecast Days To Show</div>Set the number of the days you want to show weather forecasts for.<a class="lw-open-docs" href="https://locationweather.io/docs/how-to-set-the-number-of-forecast-days-to-show/" target="_blank">Open Docs</a>', 'location-weather' ),
								'default'    => '5',
							...
							array(
								...
								'title_info' => __( '<div class="lw-info-label">Forecast Hours To Show</div>Set the number of the hours you want to show weather forecasts for.<a class="lw-open-docs" href="https://locationweather.io/docs/how-to-set-the-number-of-forecast-hours-to-show/" target="_blank">Open Docs</a>', 'location-weather' ),
								'default'    => '8',
							...
							array(
								...
								'title_info'       => __(
									'<div class="lw-info-label">Icon Type</div><div class="lw-short-content">Choose a icon type to visually represent various weather conditions in weather forecasts. These icon sets offer a variety of design options for displaying forecasted weather information.</div><div class="info-button"><a class="lw-open-docs" href="https://locationweather.io/docs/how-to-configure-forecast-data-icon-type/" target="_blank">Open Docs</a></div>',
									'location-weather'
								),
								'default'          => 'forecast_icon_set_one',
					...
					array(
						...
						'fields' => array(
							...
							array(
								...
								'text_off'   => __( 'Hide', 'location-weather' ),
								'text_width' => 75,
								'title_info' => __( '<div class="lw-info-label">Weather Attribution (Copyright)</div><div class="lw-short-content">You can show the weather attribution or copyright in the weather widget footer area for weather authenticity.</div> <a class="lw-open-docs" href="https://locationweather.io/docs/how-to-display-weather-attribution/" target="_blank">Open Docs</a>', 'location-weather' ),
							),
							array(
